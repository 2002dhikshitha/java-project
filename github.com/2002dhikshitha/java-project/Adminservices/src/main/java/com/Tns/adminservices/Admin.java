...
public class Admin {
	...
	public String toString() {
		return "Admin [ad_id=" + ad_id + ", ad_location=" + ad_location + ", ad_name=" + ad_name + ", ad_salary="
				+ ad_salary + ", ad_gender=" + ad_gender + ", ad_mall_name=" + ad_mall_name + ", ad_mail_Id="
				+ ad_mail_Id + ", getAd_id()=" + getAd_id() + ", getAd_location()=" + getAd_location()
				+ ", getAd_name()=" + getAd_name() + ", getAd_salary()=" + getAd_salary() + ", getAd_gender()="
				+ getAd_gender() + ", getAd_mall_name()=" + getAd_mall_name() + ", getAd_mail_Id()=" + getAd_mail_Id()
